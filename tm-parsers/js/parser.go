...
func lookaheadRule(lexer *Lexer, next, rule int32, lhs *stackEntry) {
	...
	case 3578:
		...
		return
	case 3579:
		if lookahead(lexer, next, 1, 5497) {
		...
		return
	case 3580:
		if lookahead(lexer, next, 4, 5500) {
		...
		return
	case 3581:
		if lookahead(lexer, next, 3, 5499) {
		...
		return
	case 3582:
		if lookahead(lexer, next, 2, 5498) {
