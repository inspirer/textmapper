...
func lookaheadRule(lexer *Lexer, next, rule int32, lhs *stackEntry) {
	switch rule {
	case 3572:
		if lookahead(lexer, next, 0, 5361) {
		...
		return
	case 3573:
		if lookahead(lexer, next, 2, 5363) {
		...
		return
	case 3574:
		if lookahead(lexer, next, 1, 5362) {
