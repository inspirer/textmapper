...
func lookaheadRule(lexer *Lexer, next, rule int32, lhs *stackEntry) {
	...
	case 3575:
		...
		return
	case 3576:
		if lookahead(lexer, next, 1, 5484) {
		...
		return
	case 3577:
		if lookahead(lexer, next, 4, 5487) {
		...
		return
	case 3578:
		if lookahead(lexer, next, 3, 5486) {
		...
		return
	case 3579:
		if lookahead(lexer, next, 2, 5485) {
