...
export const noToken = TokenType.UNAVAILABLE;
export const eoiToken = TokenType.EOI;
...
export function symbolName(sym: TokenType): string {
  if (sym === noToken) {
    return "<no-token>";
  }
  if (sym < TokenType.NumTokens) {
    return TokenType[sym];
  }
  let i = sym - TokenType.NumTokens;
...
export const Literals : TokenType[] = [
  2, 4, 10, 11, 13, 14, 15,
];
// set(follow ERROR) = 
export const afterErr : TokenType[] = [];