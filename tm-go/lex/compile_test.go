...
var compileTests = []struct {
	...
	},
	{
		...
		want: []string{
			`+2+4,+1+3,[2],+4+6+9,[3],+2+4+7,+1+3+6,[2],-1+1+4,[3],-3-1+2,-4-2+1,=>0`,
		},
	},
	{
		rules: []*Rule{
		...
		want: []string{
			`+2,+1,[2],[2]+3+7,-1+2+6,+1+5,[2],[2]-1+3,-1-2+2,-3+1,=>42`,
		},
	},
	{
		rules: []*Rule{
	...
	},
	{
		...
		want: []string{
			`[3],+2+4+6,+1+5+3,[2]+2,-1+1,[3],-3-1+1,=>11`,
		},
	},
	{
		rules: []*Rule{
