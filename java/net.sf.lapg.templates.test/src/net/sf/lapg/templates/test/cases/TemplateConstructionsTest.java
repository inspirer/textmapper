...
public class TemplateConstructionsTest extends TemplateTestCase {
	...
	public void testLoops() {
		...
		ITemplatesFacade env = new TestEnvironment(new DefaultNavigationFactory(), new ClassTemplateLoader(getClass().getClassLoader(), TEMPLATES_LOCATION, TEMPLATES_CHARSET));
