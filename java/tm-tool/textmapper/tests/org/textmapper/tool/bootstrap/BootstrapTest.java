 ...
 */
package org.textmapper.tool.bootstrap;
...
public class BootstrapTest {
	...
	public void testTextmapperTm() {
		bootstrap("src/org/textmapper/tool/parser", "textmapper.tm", new String[0], new String[]{
				"TMParser.java", "TMLexer.java", "TMTree.java"}, 6);
	}
	...
	public void testBison1Tm() {
		bootstrap("tests/org/textmapper/tool/bootstrap/bison", "bison1.tm", new String[0],
	...
	public void testSampleB() {
		bootstrap("tests/org/textmapper/tool/bootstrap/b", "sample2.tm", new String[0],
	...
	public void testSets() {
		bootstrap("tests/org/textmapper/tool/bootstrap/set", "set_test.tm",
				new String[0], new String[]{"SetLexer.java", "SetParser.java"}, 0);
	}

	@Test
	public void testUnicodeTm() {
		bootstrap("tests/org/textmapper/tool/bootstrap/unicode", "unicode.tm", new String[0],
				new String[]{"UnicodeTestLexer.java"}, 0);
	}

	@Test
	public void testEoiS() {
		bootstrap("tests/org/textmapper/tool/bootstrap/eoi", "eoi.tm", new String[0],
