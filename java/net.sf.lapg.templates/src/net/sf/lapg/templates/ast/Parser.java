...
public class Parser {
	...
	public boolean parse(String s, String templatePackage, String inputName) {
		...
		try {
			...
			return parse(new ByteArrayInputStream(buff), "utf-8");
	...
	public class Lexer {
		...
		public Lexer(InputStream stream, String encoding) throws IOException {
			this.stream = stream;
		...
		public LapgSymbol next() throws IOException, UnsupportedEncodingException {
			...
			do {			
				...
				if( state == -1 ) {
					...
					error( MessageFormat.format( "invalid lexem at line {0}: `{1}`, skipped", lapg_n.pos.line, current() ) );
					lapg_n.lexem = -1;
					continue;
				}
	...
	public boolean parse(InputStream input, String encoding) throws IOException {

		Lexer lexer = new Lexer(input, encoding);
