...
public class OptdefParser {
    ...
    private static final int lapg_action[] = {
		...
		35, -1, 36, 37, 42, 43, -1, 19, -1, -49, 15, 38, -1, -1, 46, -1,
		-1, -1, 17, -1, 33, -1, -1, 45, -1, 44, 18, 16, 48, 47, -1, -1,
		49, -1, -2,
	};
    ...
    private static final short lapg_sym_from[] = {
		97, 10, 12, 13, 15, 18, 20, 21, 24, 41, 42, 43, 44, 45, 58, 62,
		65, 70, 88, 1, 41, 42, 43, 60, 62, 65, 70, 81, 85, 86, 95, 60,
		70, 85, 86, 95, 39, 61, 53, 55, 56, 73, 79, 80, 17, 77, 94, 14,
		2, 8, 9, 38, 15, 18, 20, 58, 29, 30, 34, 37, 53, 55, 57, 76,
		60, 70, 85, 86, 95, 79, 80, 21, 24, 44, 21, 24, 44, 21, 24, 44,
		21, 24, 44, 21, 24, 44, 21, 24, 44, 0, 6, 72, 83, 50, 40, 48,
		0, 6, 21, 24, 44, 0, 6, 21, 24, 44, 0, 6, 0, 6, 21, 24,
		44, 21, 24, 44, 0, 0, 0, 6, 0, 6, 12, 13, 45, 12, 13, 18,
		20, 45, 58, 61, 72, 83, 50, 40, 40, 48, 10, 10, 15, 21, 24, 44,
		41, 42, 41, 42, 43, 62, 65, 60, 70, 85, 86, 95, 70, 70, 40, 61,
	};

    private static final short lapg_sym_to[] = {
		98, 14, 17, 17, 14, 17, 17, 28, 28, 51, 51, 51, 28, 17, 17, 51,
		51, 77, 94, 9, 52, 52, 52, 68, 52, 52, 68, 90, 68, 68, 68, 69,
		69, 69, 69, 69, 46, 72, 62, 62, 65, 83, 86, 88, 24, 85, 95, 21,
		10, 12, 13, 45, 22, 25, 27, 67, 41, 42, 43, 44, 63, 64, 66, 84,
		70, 70, 70, 70, 70, 87, 89, 29, 29, 29, 30, 30, 30, 31, 31, 31,
		32, 32, 32, 33, 33, 33, 34, 34, 34, 1, 1, 81, 81, 60, 47, 47,
		2, 2, 35, 35, 35, 3, 3, 36, 36, 36, 4, 4, 5, 5, 37, 37,
		37, 38, 38, 38, 97, 6, 7, 11, 8, 8, 18, 20, 58, 19, 19, 26,
		26, 19, 26, 73, 82, 91, 61, 48, 49, 59, 15, 16, 23, 39, 40, 57,
		53, 55, 54, 54, 56, 75, 76, 71, 78, 92, 93, 96, 79, 80, 50, 74,
	};

    private static final short lapg_rlen[] = {
		1, 2, 1, 5, 4, 4, 1, 1, 1, 2, 1, 0, 1, 0, 1, 6,
		3, 2, 2, 2, 2, 1, 1, 2, 1, 4, 1, 1, 1, 1, 1, 1,
		1, 6, 4, 4, 4, 4, 3, 1, 1, 1, 1, 1, 3, 3, 1, 3,
		3, 5,
	};

    private static final short lapg_rlex[] = {
		32, 33, 33, 34, 34, 34, 35, 35, 35, 36, 36, 51, 51, 52, 52, 37,
		38, 38, 39, 40, 41, 41, 42, 43, 43, 44, 45, 45, 45, 45, 45, 45,
		45, 45, 45, 45, 45, 45, 46, 46, 47, 47, 48, 48, 48, 48, 49, 49,
		50, 50,
	};
	...
	public interface Tokens extends Lexems {
		...
		public static final int optionslistopt = 52;
	}
	...
	public Object parse(OptdefLexer lexer) throws IOException, ParseException {
		...
		while( lapg_m[lapg_head].state != 98 ) {
