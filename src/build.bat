...
.\out\txt2c++.exe templates.cpp templ_cs templ_cpp templ_js templ_java
.\out\txt2c++.exe defaults.cpp default_cpp default_cs default_js default_java
...
link /nologo /OUT:"out/lapg.exe" /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /MACHINE:X86 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib out\common.obj out\defaults.obj out\engine.obj out\gbuild.obj out\lalr1.obj out\lapg.obj out\lbuild.obj out\parse.obj out\srcgen.obj out\templates.obj
