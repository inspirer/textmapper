...
public class BisonLexer {
	...
	public interface Tokens {
		...
		int CHAR = 5;
		int STRING = 6;
		int LessMultGreater = 7;
		int LessGreater = 8;
		int PercentPercent = 9;
		int Or = 10;
		int Semicolon = 11;
		int Lsquare = 12;
		int Rsquare = 13;
		...
		int Percentnterm = 17;
		int Percenttype = 18;
		int Percentdestructor = 19;
		int Percentprinter = 20;
		int Percentleft = 21;
		int Percentright = 22;
		int Percentnonassoc = 23;
		int Percentprecedence = 24;
		int Percentprec = 25;
		int Percentdprec = 26;
		int Percentmerge = 27;
		int Percentcode = 28;
		int PercentdefaultMinusprec = 29;
		int Percentdefine = 30;
		int Percentdefines = 31;
		int Percentempty = 32;
		int PercenterrorMinusverbose = 33;
		int Percentexpect = 34;
		int PercentexpectMinusrr = 35;
		int PercentLessflagGreater = 36;
		int PercentfileMinusprefix = 37;
		int PercentglrMinusparser = 38;
		int PercentinitialMinusaction = 39;
		int Percentlanguage = 40;
		int PercentnameMinusprefix = 41;
		int PercentnoMinusdefaultMinusprec = 42;
		int PercentnoMinuslines = 43;
		int PercentnondeterministicMinusparser = 44;
		int Percentoutput = 45;
		int Percentparam = 46;
		int Percentrequire = 47;
		int Percentskeleton = 48;
		int Percentstart = 49;
		int PercenttokenMinustable = 50;
		int Percentunion = 51;
		int Percentverbose = 52;
		int Percentyacc = 53;
		int LcurlyDotDotDotRcurly = 54;
		int PercentQuestionmarkLcurlyDotDotDotRcurly = 55;
		int PercentLcurlyDotDotDotPercentRcurly = 56;
		int tag_any = 57;
