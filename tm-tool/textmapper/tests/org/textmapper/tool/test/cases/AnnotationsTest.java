...
public class AnnotationsTest extends LapgTestCase {
	...
	public void testBadAnnotations() {
		TestStatus notifier = new TestStatus("", "syntax1errannotated,29: notexistingsym cannot be resolved\n"
				+ "syntax1errannotated,35: redeclaration of annotation `name' for non-terminal: tempanno, skipped\n");
