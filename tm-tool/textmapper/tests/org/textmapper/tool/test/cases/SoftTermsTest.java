...
import org.textmapper.tool.test.bootstrap.b.ast.AstVisitor;
...
public class SoftTermsTest extends LapgTestCase {
	...
	public void testSoftConflictsHandling_ShiftShift() {
		...
		er.reset(
				"",
				"syntax_softconflicts_ss,30: input: Lclass identifier '('\n" +
						...
						"\n" +
						"syntax_softconflicts_ss,30: input: Lclass identifier '(' memberslist\n" +
						"shift soft/class conflict (next: identifier, Lclass)\n" +
						"    member ::= identifier '(' ')'\n" +
						"    classdef ::= Lclass identifier '(' memberslist ')'\n" +
						"    classdef ::= Lclass identifier Lextends identifier '(' memberslist ')'\n" +
						"\n" +
						"syntax_softconflicts_ss,30: input: Lclass identifier Lextends identifier '('\n" +
						"shift soft/class conflict (next: identifier, Lclass)\n" +
						"    member ::= identifier '(' ')'\n" +
						"    classdef ::= Lclass identifier '(' memberslist ')'\n" +
						"    classdef ::= Lclass identifier Lextends identifier '(' memberslist ')'\n" +
						"\n" +
						"syntax_softconflicts_ss,30: input: Lclass identifier Lextends identifier '(' memberslist\n" +
						"shift soft/class conflict (next: identifier, Lclass)\n" +
						"    member ::= identifier '(' ')'\n" +
						"    classdef ::= Lclass identifier '(' memberslist ')'\n" +
						"    classdef ::= Lclass identifier Lextends identifier '(' memberslist ')'\n" +
	...
	public void testSoftConflictsHandling_ShiftReduce() {
		...
		er.reset(
				"",
				"syntax_softconflicts_sr,34: input: Lclass identifier '(' identifier\n" +
	...
	public void testSoftConflictsHandling_ReduceReduce() {
		...
		er.reset(
				"",
				"syntax_softconflicts_rr,34: input: Lclass identifier '(' identifier\n" +
